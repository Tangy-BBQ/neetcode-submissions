class Solution:
    def pacificAtlantic(self, heights: List[List[int]]) -> List[List[int]]:
        ...
        valid_grid = [[None for _ in range(len(heights[0]))] for _ in range(len(heights))]
        ...
        def dfs(x, y, prev_height):
            ...
            if valid_grid[x][y] is not None:
                return valid_grid[x][y]
